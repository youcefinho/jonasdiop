...
export const ROUTES: RoutePaths = {
  ...
  'services-gamechanger-scaling': { fr: '/services/gamechanger-scaling', en: '/en/services/gamechanger-scaling' },
  ...
  'services-consultations-privees': { fr: '/services/consultations-privees', en: '/en/services/private-consultations' },
