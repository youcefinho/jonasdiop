      ...
      >
        <div className="flex flex-col items-center gap-md max-w-content mx-auto">
          ...
          <MaskRevealHeading as="h1">
            <span className="text-shimmer">{t(podcastCopy.hero.h1)}</span>
          </MaskRevealHeading>
            ...
            >
              {platforms.map((p) => {
                ...
                return (
                  <li
                    key={p.platform}
                    className="hover-lift shadow-haptic-card shadow-haptic-card-hover transition-all duration-base flex flex-col items-center text-center gap-sm p-md bg-base border border-silver/15 rounded-lg"
                  >
                    <span
                      aria-hidden="true"
