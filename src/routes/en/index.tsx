...
function HomeEN() {
  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center gap-md p-md">
      <p className="text-eyebrow uppercase tracking-widest text-silver">Setup OK · Sprint 0</p>
      <h1 className="text-hero text-primary text-balance">Jonas Diop — Business Architect</h1>
