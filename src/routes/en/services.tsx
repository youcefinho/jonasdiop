...
/**
 * /en/services — EN mirror of /services hub
 * Identical component — locale resolved to 'en' via LanguageProvider (/en/ routing).
 * All BilingualLax.en values resolve via useT().
 */
function ServicesENPage() {
  const { t, locale } = useT();
  ...
  return (
    <>
      ...
      <main className="pt-[80px]">
        ...
        {/* ─── PULL QUOTE — Jonas's "fail to plan" line ───────────────────── */}
        <ScrollReveal>
