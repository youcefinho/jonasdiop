...
/**
 * /en/cdt-methodology — EN mirror of /methodologie-cdt
 * Identical component, locale resolved via LanguageProvider (set to 'en' by /en/ routing).
 * CDT™ copy resolves to BilingualLax.en via useT().
 */
function MethodologieCdtENPage() {
  const { t, locale } = useT();
      ...
      <main className="pt-[80px]">
        ...
        >
          <div className="max-w-[var(--container-default)] mx-auto px-[clamp(1rem,4vw,3rem)]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-[clamp(0.75rem,1.5vw,1.5rem)]">
              {copy.phases.items.map((phase) => (
                <article
                  ...
                  className={[
                    ...
                    'shadow-[inset_0_1px_1px_oklch(1_0_0_/_0.06)]'
                  ].join(' ')}
                >
                  <span
                    aria-hidden="true"
        ...
        <section
          ...
          className="py-[clamp(3.5rem,7vw,8rem)] bg-elevated border-t border-silver/10"
        >
...
export const Route = createFileRoute('/en/cdt-methodology')({
  component: MethodologieCdtENPage
});
